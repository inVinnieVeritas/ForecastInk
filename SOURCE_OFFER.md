...
- Upstream repository: https://github.com/NiLuJe/FBInk
- Release: https://github.com/NiLuJe/FBInk/releases/tag/v1.25.0
...
- `fbink/bin/fbink` SHA-256: `1a9808aabcd9b3aeea939a123c0fb576768ca9e58362523cc451a8a42f6ccbeb5`
- `fbink/lib/libfbink.so.1.0.0` SHA-256: `446a369d8c1438fd93dcab095e5680d5c5b41bbff6f4c569132a4fc597a775b9`

This source-access notice supplements, and does not replace, the full GPL license and upstream credits included in:

- `licenses/FBInk-GPL-3.0-or-later.txt`
- `licenses/FBInk-CREDITS.txt`
